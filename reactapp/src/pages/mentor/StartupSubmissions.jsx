                                        ...
                                        <tr key={submission._id} className="group transition-all duration-300 hover:bg-black/[0.02] dark:hover:bg-white/[0.02]">
                                            ...
                                            <td className="px-8 py-6 text-right">
                                                <div className="flex items-center justify-end gap-3">
                                                    ...
                                                    {!submission.isWithdrawn && submission.status === 'pending' && (
                                                        <>
                                                            <button 
                                                    ...
                                                    {(submission.isWithdrawn || submission.rejectionFeedback) && (
                                                        <button 
                                                            onClick={() => handleOpenReasonModal(submission.isWithdrawn ? "Withdrawal Reason" : "Rejection Feedback", submission.isWithdrawn ? submission.withdrawalReason : submission.rejectionFeedback)}
                                                            className="p-3 rounded-2xl transition-all hover:scale-110 active:scale-95 border-2"
